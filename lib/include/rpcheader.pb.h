...
class RpcHeader :
 ...
 public:
  ...
  enum : int {
    kServeceNameFieldNumber = 1,
    kMethodNameFieldNumber = 2,
    kArgsSizeFieldNumber = 3,
  };
  // bytes servece_name = 1;
  void clear_servece_name();
  const std::string& servece_name() const;
  void set_servece_name(const std::string& value);
  void set_servece_name(std::string&& value);
  void set_servece_name(const char* value);
  void set_servece_name(const void* value, size_t size);
  std::string* mutable_servece_name();
  std::string* release_servece_name();
  void set_allocated_servece_name(std::string* servece_name);
  private:
  const std::string& _internal_servece_name() const;
  void _internal_set_servece_name(const std::string& value);
  std::string* _internal_mutable_servece_name();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr servece_name_;
...
// bytes servece_name = 1;
inline void RpcHeader::clear_servece_name() {
  servece_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RpcHeader::servece_name() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.servece_name)
  return _internal_servece_name();
}
inline void RpcHeader::set_servece_name(const std::string& value) {
  _internal_set_servece_name(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.servece_name)
}
inline std::string* RpcHeader::mutable_servece_name() {
  // @@protoc_insertion_point(field_mutable:mprpc.RpcHeader.servece_name)
  return _internal_mutable_servece_name();
}
inline const std::string& RpcHeader::_internal_servece_name() const {
  return servece_name_.GetNoArena();
}
inline void RpcHeader::_internal_set_servece_name(const std::string& value) {
  
  servece_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RpcHeader::set_servece_name(std::string&& value) {
  
  servece_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mprpc.RpcHeader.servece_name)
}
inline void RpcHeader::set_servece_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  servece_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mprpc.RpcHeader.servece_name)
}
inline void RpcHeader::set_servece_name(const void* value, size_t size) {
  
  servece_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mprpc.RpcHeader.servece_name)
}
inline std::string* RpcHeader::_internal_mutable_servece_name() {
  
  return servece_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RpcHeader::release_servece_name() {
  // @@protoc_insertion_point(field_release:mprpc.RpcHeader.servece_name)
  
  return servece_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RpcHeader::set_allocated_servece_name(std::string* servece_name) {
  if (servece_name != nullptr) {
    
  } else {
    
  }
  servece_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), servece_name);
  // @@protoc_insertion_point(field_set_allocated:mprpc.RpcHeader.servece_name)
}
