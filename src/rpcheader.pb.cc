...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, servece_name_),
...
const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\014servece_name\030\001 \001(\014\022\023\n\013method_name\030\002 \001(\014"
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  servece_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_servece_name().empty()) {
    servece_name_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.servece_name_);
  }
...
void RpcHeader::SharedDtor() {
  servece_name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_servece_name();
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  // bytes servece_name = 1;
  if (this->servece_name().size() > 0) {
    target = stream->WriteBytesMaybeAliased(
        1, this->_internal_servece_name(), target);
  }
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  servece_name_.Swap(&other->servece_name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
